...
@RestController
@RequestMapping("/api/camunda-server-kafka")
public class CamundaServerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CamundaServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CamundaServerKafkaResource(KafkaProperties kafkaProperties) {
